...
%counterfeit-websites
countermeasure(counterfeit_websites, only_click_on_familiar_links,96).
countermeasure(counterfeit_websites, employee_education, 82).
countermeasure(counterfeit_websites, antivirus, 76).
countermeasure(typo_squatting, authenticate_all_servers, 87).
...
%spear-phishing
countermeasure(spear_phishing, only_click_on_familiar_links,95).
countermeasure(spear_phishing, employee_education, 89).
countermeasure(spear_phishing, turn_on_spam_filter, 94).
countermeasure(spear_phishing, bad_grammar_check, 83).
countermeasure(spear_phishing, two_way_authentification, 80).
countermeasure(spear_phishing, antivirus, 81).

%mobile-phishing
countermeasure(mobile_phishing, only_click_on_familiar_links,49).
countermeasure(mobile_phishing, employee_education, 85).
countermeasure(mobile_phishing, bad_grammar_check, 73).
countermeasure(mobile_phishing, antivirus, 80).
countermeasure(mobile_phishing, not_responding_to_unknown_number, 97).
countermeasure(mobile_phishing, give_only_required_information, 92).

%voice-phishing
countermeasure(voice_phishing, employee_education, 89).
countermeasure(voice_phishing, not_responding_to_unknown_number, 98).
countermeasure(voice_phishing, give_only_required_information, 94).

%typo-squatting
countermeasure(typo_squatting, only_click_on_familiar_links,97).
countermeasure(typo_squatting, employee_education, 90).
countermeasure(typo_squatting, antivirus, 79).
countermeasure(typo_squatting, authenticate_all_servers, 93).
countermeasure(typo_squatting, DNS_hostnames_check, 94). 

%sound-squatting
countermeasure(sound_squatting, only_click_on_familiar_links,96).
countermeasure(sound_squatting, employee_education, 90).
countermeasure(sound_squatting, antivirus, 78).
countermeasure(sound_squatting, authenticate_all_servers, 94).
countermeasure(sound_squatting, DNS_hostnames_check, 95). 

%homograph-attack-via-homoglyphs
countermeasure(homograph_attack_via_homoglyphs, only_click_on_familiar_links,95).
countermeasure(homograph_attack_via_homoglyphs, employee_education, 90).
countermeasure(homograph_attack_via_homoglyphs, antivirus, 79).
countermeasure(homograph_attack_via_homoglyphs, authenticate_all_servers, 95).
countermeasure(homograph_attack_via_homoglyphs, DNS_hostnames_check, 95). 
countermeasure(homograph_attack_via_homoglyphs, browsers_that_can_warn_about_characters_from_different_character_sets, 96). 

%bit-squatting
countermeasure(bit_squatting, only_click_on_familiar_links,94).
countermeasure(bit_squatting, employee_education, 93).
countermeasure(bit_squatting, antivirus, 79).
countermeasure(bit_squatting, authenticate_all_servers, 94).
countermeasure(bit_squatting, DNS_hostnames_check, 92). 
countermeasure(bit_squatting, error_correcting_memory, 93). 

%pretexting-via-customer-service
countermeasure(pretexting_via_customer_service, validate_phone_number, 95).
countermeasure(pretexting_via_customer_service, employee_education,47).

%dns-domain-seizure
countermeasure(dns_domain_seizure, contact_emergency_services, 95).
countermeasure(dns_domain_seizure, restore_from_back_up, 77).

%influence-via-incentives
countermeasure(influence_via_incentives, educate_employees, 81).
countermeasure(influence_via_incentives, give_only_required_information, 59).

%harvesting-information-via-api-event-monitoring
countermeasure(harvesting_information_via_api_event_monitoring, encrypt_data_transmission,93).

%flash-file-overlay
countermeasure(flash_file_overlay, turn_off_flash, 99).
countermeasure(flash_file_overlay, evaluate_email_protection , 84).
countermeasure(flash_file_overlay, employee_education,77).

%iframe-overlay
countermeasure(iframe_overlay, disable_iframes, 95).
countermeasure(iframe_overlay, evaluate_email_protection , 92).
countermeasure(iframe_overlay, add_csp , 88).
countermeasure(iframe_overlay, employee_education,77).

%credential-prompt-impersonation
countermeasure(credential_prompt_impersonation, avoid_installing_malicious_applications, 88).
countermeasure(credential_prompt_impersonation, avoid_suspicious_applications_with_GET_TASKS_permission, 79).
countermeasure(credential_prompt_impersonation, employee_education,72).

%android-activity-hijack
countermeasure(android_activity_hijack, ah_detecor, 94).
...
countermeasure(malicious_manual_software_update, validate_software_updates, 88).
countermeasure(malicious_manual_software_update, install_MSRT, 70).
countermeasure(malicious_manual_software_update, employee_education, 65).

%rooting-sim-cards
countermeasure(rooting_sim_cards, upgrade_sim_card_to_use_AES, 98).
countermeasure(rooting_sim_cards, upgrade_sim_card_to_use_DES, 72).

%target-influence-via-interview-and-interrogation
countermeasure(target_influence_via_interview_and_interrogation, employee_education,84).

%influence-via-modes-of-thinking
countermeasure(influence_via_modes_of_thinking, employee_education,82).

%target-influence-via-framing
countermeasure(target_influence_via_framing, employee_education,81).
...
%influence-perception-of-authority
countermeasure(influence_perception_of_authority, employee_education,78).

%influence-perception-of-scarcity
countermeasure(influence_perception_of_scarcity, employee_education,89).

%influence-perception-of-reciprocation
countermeasure(influence_perception_of_reciprocation, employee_education,81).

%pretexting-via-phone
countermeasure(pretexting_via_phone, employee_education,82).
countermeasure(pretexting_via_phone, validate_phone_number,48).

%pretexting-via-delivery-person
countermeasure(pretexting_via_delivery_person, employee_education,80).
countermeasure(pretexting_via_delivery_person, validate_phone_number,43).

%pretexting-via-tech-support
countermeasure(pretexting_via_tech_support, employee_education,70).
countermeasure(pretexting_via_tech_support, validate_phone_number,47).
